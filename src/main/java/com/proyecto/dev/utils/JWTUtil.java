...
public class JWTUtil {
	...
	public String create(String id, String subject, List<AlumnoRolDto> listaAlumnoRolDto) {
		...
		JwtBuilder builder = Jwts.builder().setId(id).setIssuedAt(now).setSubject(subject)
				.claim("userRole", listaAlumnoRolDto).setIssuer(issuer).signWith(signatureAlgorithm, signingKey);
